...
namespace Poderosa.Terminal.Sixel {
    ...
    class HlsSupportTest {
        ...
        [TestCase(0, 25, 25, 79, 47, 47)]
        [TestCase(0, 25, 50, 95, 31, 31)]
        [TestCase(0, 25, 75, 111, 15, 15)]
        [TestCase(0, 25, 100, 127, 0, 0)]
        [TestCase(0, 50, 0, 127, 127, 127)]
        [TestCase(0, 50, 25, 159, 95, 95)]
        [TestCase(0, 50, 50, 191, 63, 63)]
        [TestCase(0, 50, 75, 223, 31, 31)]
        [TestCase(0, 50, 100, 255, 0, 0)]
        [TestCase(0, 75, 0, 191, 191, 191)]
        [TestCase(0, 75, 25, 207, 175, 175)]
        [TestCase(0, 75, 50, 223, 159, 159)]
        [TestCase(0, 75, 75, 239, 143, 143)]
        [TestCase(0, 75, 100, 255, 127, 127)]
        ...
        [TestCase(30, 25, 25, 79, 63, 47)]
        [TestCase(30, 25, 50, 95, 63, 31)]
        [TestCase(30, 25, 75, 111, 63, 15)]
        [TestCase(30, 25, 100, 127, 63, 0)]
        [TestCase(30, 50, 0, 127, 127, 127)]
        [TestCase(30, 50, 25, 159, 127, 95)]
        [TestCase(30, 50, 50, 191, 127, 63)]
        [TestCase(30, 50, 75, 223, 127, 31)]
        [TestCase(30, 50, 100, 255, 127, 0)]
        [TestCase(30, 75, 0, 191, 191, 191)]
        [TestCase(30, 75, 25, 207, 191, 175)]
        [TestCase(30, 75, 50, 223, 191, 159)]
        [TestCase(30, 75, 75, 239, 191, 143)]
        [TestCase(30, 75, 100, 255, 191, 127)]
        ...
        [TestCase(60, 25, 25, 79, 79, 47)]
        [TestCase(60, 25, 50, 95, 95, 31)]
        [TestCase(60, 25, 75, 111, 111, 15)]
        [TestCase(60, 25, 100, 127, 127, 0)]
        [TestCase(60, 50, 0, 127, 127, 127)]
        [TestCase(60, 50, 25, 159, 159, 95)]
        [TestCase(60, 50, 50, 191, 191, 63)]
        [TestCase(60, 50, 75, 223, 223, 31)]
        [TestCase(60, 50, 100, 255, 255, 0)]
        [TestCase(60, 75, 0, 191, 191, 191)]
        [TestCase(60, 75, 25, 207, 207, 175)]
        [TestCase(60, 75, 50, 223, 223, 159)]
        [TestCase(60, 75, 75, 239, 239, 143)]
        [TestCase(60, 75, 100, 255, 255, 127)]
        ...
        [TestCase(90, 25, 25, 63, 79, 47)]
        [TestCase(90, 25, 50, 63, 95, 31)]
        [TestCase(90, 25, 75, 63, 111, 15)]
        [TestCase(90, 25, 100, 63, 127, 0)]
        [TestCase(90, 50, 0, 127, 127, 127)]
        [TestCase(90, 50, 25, 127, 159, 95)]
        [TestCase(90, 50, 50, 127, 191, 63)]
        [TestCase(90, 50, 75, 127, 223, 31)]
        [TestCase(90, 50, 100, 127, 255, 0)]
        [TestCase(90, 75, 0, 191, 191, 191)]
        [TestCase(90, 75, 25, 191, 207, 175)]
        [TestCase(90, 75, 50, 191, 223, 159)]
        [TestCase(90, 75, 75, 191, 239, 143)]
        [TestCase(90, 75, 100, 191, 255, 127)]
        ...
        [TestCase(120, 25, 25, 47, 79, 47)]
        [TestCase(120, 25, 50, 31, 95, 31)]
        [TestCase(120, 25, 75, 15, 111, 15)]
        [TestCase(120, 25, 100, 0, 127, 0)]
        [TestCase(120, 50, 0, 127, 127, 127)]
        [TestCase(120, 50, 25, 95, 159, 95)]
        [TestCase(120, 50, 50, 63, 191, 63)]
        [TestCase(120, 50, 75, 31, 223, 31)]
        [TestCase(120, 50, 100, 0, 255, 0)]
        [TestCase(120, 75, 0, 191, 191, 191)]
        [TestCase(120, 75, 25, 175, 207, 175)]
        [TestCase(120, 75, 50, 159, 223, 159)]
        [TestCase(120, 75, 75, 143, 239, 143)]
        [TestCase(120, 75, 100, 127, 255, 127)]
        ...
        [TestCase(150, 25, 25, 47, 79, 63)]
        [TestCase(150, 25, 50, 31, 95, 63)]
        [TestCase(150, 25, 75, 15, 111, 63)]
        [TestCase(150, 25, 100, 0, 127, 63)]
        [TestCase(150, 50, 0, 127, 127, 127)]
        [TestCase(150, 50, 25, 95, 159, 127)]
        [TestCase(150, 50, 50, 63, 191, 127)]
        [TestCase(150, 50, 75, 31, 223, 127)]
        [TestCase(150, 50, 100, 0, 255, 127)]
        [TestCase(150, 75, 0, 191, 191, 191)]
        [TestCase(150, 75, 25, 175, 207, 191)]
        [TestCase(150, 75, 50, 159, 223, 191)]
        [TestCase(150, 75, 75, 143, 239, 191)]
        [TestCase(150, 75, 100, 127, 255, 191)]
        ...
        [TestCase(180, 25, 25, 47, 79, 79)]
        [TestCase(180, 25, 50, 31, 95, 95)]
        [TestCase(180, 25, 75, 15, 111, 111)]
        [TestCase(180, 25, 100, 0, 127, 127)]
        [TestCase(180, 50, 0, 127, 127, 127)]
        [TestCase(180, 50, 25, 95, 159, 159)]
        [TestCase(180, 50, 50, 63, 191, 191)]
        [TestCase(180, 50, 75, 31, 223, 223)]
        [TestCase(180, 50, 100, 0, 255, 255)]
        [TestCase(180, 75, 0, 191, 191, 191)]
        [TestCase(180, 75, 25, 175, 207, 207)]
        [TestCase(180, 75, 50, 159, 223, 223)]
        [TestCase(180, 75, 75, 143, 239, 239)]
        [TestCase(180, 75, 100, 127, 255, 255)]
        ...
        [TestCase(210, 25, 25, 47, 63, 79)]
        [TestCase(210, 25, 50, 31, 63, 95)]
        [TestCase(210, 25, 75, 15, 63, 111)]
        [TestCase(210, 25, 100, 0, 63, 127)]
        [TestCase(210, 50, 0, 127, 127, 127)]
        [TestCase(210, 50, 25, 95, 127, 159)]
        [TestCase(210, 50, 50, 63, 127, 191)]
        [TestCase(210, 50, 75, 31, 127, 223)]
        [TestCase(210, 50, 100, 0, 127, 255)]
        [TestCase(210, 75, 0, 191, 191, 191)]
        [TestCase(210, 75, 25, 175, 191, 207)]
        [TestCase(210, 75, 50, 159, 191, 223)]
        [TestCase(210, 75, 75, 143, 191, 239)]
        [TestCase(210, 75, 100, 127, 191, 255)]
        ...
        [TestCase(240, 25, 25, 47, 47, 79)]
        [TestCase(240, 25, 50, 31, 31, 95)]
        [TestCase(240, 25, 75, 15, 15, 111)]
        [TestCase(240, 25, 100, 0, 0, 127)]
        [TestCase(240, 50, 0, 127, 127, 127)]
        [TestCase(240, 50, 25, 95, 95, 159)]
        [TestCase(240, 50, 50, 63, 63, 191)]
        [TestCase(240, 50, 75, 31, 31, 223)]
        [TestCase(240, 50, 100, 0, 0, 255)]
        [TestCase(240, 75, 0, 191, 191, 191)]
        [TestCase(240, 75, 25, 175, 175, 207)]
        [TestCase(240, 75, 50, 159, 159, 223)]
        [TestCase(240, 75, 75, 143, 143, 239)]
        [TestCase(240, 75, 100, 127, 127, 255)]
        ...
        [TestCase(270, 25, 25, 63, 47, 79)]
        [TestCase(270, 25, 50, 63, 31, 95)]
        [TestCase(270, 25, 75, 63, 15, 111)]
        [TestCase(270, 25, 100, 63, 0, 127)]
        [TestCase(270, 50, 0, 127, 127, 127)]
        [TestCase(270, 50, 25, 127, 95, 159)]
        [TestCase(270, 50, 50, 127, 63, 191)]
        [TestCase(270, 50, 75, 127, 31, 223)]
        [TestCase(270, 50, 100, 127, 0, 255)]
        [TestCase(270, 75, 0, 191, 191, 191)]
        [TestCase(270, 75, 25, 191, 175, 207)]
        [TestCase(270, 75, 50, 191, 159, 223)]
        [TestCase(270, 75, 75, 191, 143, 239)]
        [TestCase(270, 75, 100, 191, 127, 255)]
        ...
        [TestCase(300, 25, 25, 79, 47, 79)]
        [TestCase(300, 25, 50, 95, 31, 95)]
        [TestCase(300, 25, 75, 111, 15, 111)]
        [TestCase(300, 25, 100, 127, 0, 127)]
        [TestCase(300, 50, 0, 127, 127, 127)]
        [TestCase(300, 50, 25, 159, 95, 159)]
        [TestCase(300, 50, 50, 191, 63, 191)]
        [TestCase(300, 50, 75, 223, 31, 223)]
        [TestCase(300, 50, 100, 255, 0, 255)]
        [TestCase(300, 75, 0, 191, 191, 191)]
        [TestCase(300, 75, 25, 207, 175, 207)]
        [TestCase(300, 75, 50, 223, 159, 223)]
        [TestCase(300, 75, 75, 239, 143, 239)]
        [TestCase(300, 75, 100, 255, 127, 255)]
        ...
        [TestCase(330, 25, 25, 79, 47, 63)]
        [TestCase(330, 25, 50, 95, 31, 63)]
        [TestCase(330, 25, 75, 111, 15, 63)]
        [TestCase(330, 25, 100, 127, 0, 63)]
        [TestCase(330, 50, 0, 127, 127, 127)]
        [TestCase(330, 50, 25, 159, 95, 127)]
        [TestCase(330, 50, 50, 191, 63, 127)]
        [TestCase(330, 50, 75, 223, 31, 127)]
        [TestCase(330, 50, 100, 255, 0, 127)]
        [TestCase(330, 75, 0, 191, 191, 191)]
        [TestCase(330, 75, 25, 207, 175, 191)]
        [TestCase(330, 75, 50, 223, 159, 191)]
        [TestCase(330, 75, 75, 239, 143, 191)]
        [TestCase(330, 75, 100, 255, 127, 191)]
        ...
        [TestCase(360, 25, 25, 79, 47, 47)]
        [TestCase(360, 25, 50, 95, 31, 31)]
        [TestCase(360, 25, 75, 111, 15, 15)]
        [TestCase(360, 25, 100, 127, 0, 0)]
        [TestCase(360, 50, 0, 127, 127, 127)]
        [TestCase(360, 50, 25, 159, 95, 95)]
        [TestCase(360, 50, 50, 191, 63, 63)]
        [TestCase(360, 50, 75, 223, 31, 31)]
        [TestCase(360, 50, 100, 255, 0, 0)]
        [TestCase(360, 75, 0, 191, 191, 191)]
        [TestCase(360, 75, 25, 207, 175, 175)]
        [TestCase(360, 75, 50, 223, 159, 159)]
        [TestCase(360, 75, 75, 239, 143, 143)]
        [TestCase(360, 75, 100, 255, 127, 127)]
