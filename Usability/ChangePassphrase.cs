 ...
 *
 * $Id: ChangePassphrase.cs,v 1.2 2011/10/27 23:21:59 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms {
    ...
    internal class ChangePassphrase : System.Windows.Forms.Form {
        ...
        public ChangePassphrase() {
            ...
            this._lKeyFile.Text = sr.GetString("Form.ChangePassphrase._lKeyFile");
            this._lCurrentPassphrase.Text = sr.GetString("Form.ChangePassphrase._lCurrentPassphrase");
            this._lNewPassphrase.Text = sr.GetString("Form.ChangePassphrase._lNewPassphrase");
            this._lNewPassphraseAgain.Text = sr.GetString("Form.ChangePassphrase._lNewPassphraseAgain");
            this._okButton.Text = sr.GetString("Common.OK");
            this._cancelButton.Text = sr.GetString("Common.Cancel");
            this.Text = sr.GetString("Form.ChangePassphrase.Text");
        }
