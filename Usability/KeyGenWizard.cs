 ...
 *
 * $Id: KeyGenWizard.cs,v 1.3 2012/03/05 14:42:21 kzmi Exp $
 */
using System;
using System.IO;
...
namespace Poderosa.Forms {
    ...
    internal class KeyGenWizard : System.Windows.Forms.Form {
        ...
        public KeyGenWizard() {
            ...
            this._confirmLabel.Text = sr.GetString("Form.KeyGenWizard._confirmLabel");
            this._passphraseLabel.Text = sr.GetString("Form.KeyGenWizard._passphraseLabel");
            this._bitCountLabel.Text = sr.GetString("Form.KeyGenWizard._bitCountLabel");
            this._algorithmLabel.Text = sr.GetString("Form.KeyGenWizard._algorithmLabel");
            this._promptLabel1.Text = sr.GetString("Form.KeyGenWizard._promptLabel1");
            this._nextButton.Text = sr.GetString("Form.KeyGenWizard._nextButton");
            this._cancelButton.Text = sr.GetString("Common.Cancel");
            this._keygenLabel.Text = sr.GetString("Form.KeyGenWizard._keygenLabel");
            this._storePrivateKey.Text = sr.GetString("Form.KeyGenWizard._storePrivateKey");
            this._storeSECSHPublicKeyButton.Text = sr.GetString("Form.KeyGenWizard._storeSECSHPublicKeyButton");
            this._storeOpenSSHPublicKeyButton.Text = sr.GetString("Form.KeyGenWizard._storeOpenSSHPublicKeyButton");
            this._completeLabel.Text = sr.GetString("Form.KeyGenWizard._completeLabel");
            this.Text = sr.GetString("Form.KeyGenWizard.Text");
        ...
        /// <exclude/>
        public delegate void FinishDelegate(SSH2UserAuthKey key);
        ...
        private void CheckGenerationComplete() {
            ...
            if (_generationBar.Value == _generationBar.Maximum && _resultKey != null) {
                ...
                _keygenLabel.Text = sr.GetString("Message.KeyGenWizard.GenerationCompleted");
        ...
        private void OnNext(object sender, EventArgs args) {
            ...
            switch (_page) {
                ...
                case Page.Generation:
                    ...
                    _page = Page.Store;
                    _nextButton.Text = sr.GetString("Message.KeyGenWizard.Finish");
                    break;
                case Page.Store:
                    Close();
                    break;
        ...
        public void SetProgressValue(int v) {
            ...
            if (v == _generationBar.Maximum) {
                StringResource sr = SSHUtilPlugin.Instance.Strings;
                _keygenLabel.Text = sr.GetString("Message.KeyGenWizard.RandomNumberCompleted");
        ...
        private void OnSaveSECSHPublicKey(object sender, EventArgs args) {
            StringResource sr = SSHUtilPlugin.Instance.Strings;
            SaveFileDialog dlg = new SaveFileDialog();
            dlg.Title = sr.GetString("Caption.KeyGenWizard.SavePublicInSECSH");
            dlg.DefaultExt = "pub";
    ...
    internal class KeyGenThread {
        ...
        private void EntryPoint() {
            try {
                ...
                _parent.Invoke(new KeyGenWizard.FinishDelegate(_parent.SetResultKey), new SSH2UserAuthKey(kp));
            }
            catch (Exception ex) {
