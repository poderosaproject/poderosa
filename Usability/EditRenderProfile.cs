...
namespace Poderosa.Forms {
    internal class EditRenderProfile : System.Windows.Forms.Form {
        ...
        private void OnOK(object sender, EventArgs args) {
            if (_backgroundImageBox.Text.Length > 0) {
                try {
                    ...
                    GUtil.Warning(this, String.Format(TerminalUIPlugin.Instance.Strings.GetString("Message.EditRenderProfile.InvalidPicture"), _backgroundImageBox.Text));
        ...
        public static string SelectPictureFileByDialog(Form parent) {
            ...
            dlg.Title = TerminalUIPlugin.Instance.Strings.GetString("Util.SelectPicture.Caption");
