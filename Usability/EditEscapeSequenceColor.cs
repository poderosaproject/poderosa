 ...
 *
 * $Id: EditEscapeSequenceColor.cs,v 1.3 2012/05/27 15:22:50 kzmi Exp $
 */
using System;
...
namespace Poderosa.Forms {
    internal class EditEscapeSequenceColor : System.Windows.Forms.Form {
        ...
        private void AddUI(int index, int y, ref int tabindex) {
            ...
            sample.ForeColor = index == -1 ? _foreColor : _esColorSet[index].Color;
            sample.TabIndex = tabindex++;

            ColorButton col = new ColorButton();
            col.SelectedColor = index == -1 ? _foreColor : _esColorSet[index].Color;
            col.Left = 122;
            col.Width = 128;
            col.Top = y + 2;
